            ...
            <div className="flex justify-between items-start">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 mt-2">
                  ...
                  {record.type === 'prescription' && record.prescriptionMatricule && (
                    <div className="flex items-center gap-2 px-4 py-2 bg-white/30 rounded-lg">
                      <span className="text-sm font-semibold">Matricule ordonnance:</span>
                      <span className="font-mono text-lg font-bold">{record.prescriptionMatricule}</span>
                    </div>
                  )}
                </div>
              </div>
